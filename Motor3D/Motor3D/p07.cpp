...
float p[POINT_COUNT][3] = {{-1.05,-1.05,0},{-1.4,-0.5,0},{-1.5,0,0},{-1.4,0.5,0},{-1.05,1.05,0},{-0.5,1.4,0},{0,1.5,0},{0.5,1.4,0},{1.05,1.05,0},{1.4,0.5,0},{1.5,0,0},{1.4,-0.5,0},{1.05,-1.05,0},{0.5,-1.4,0},{0,-1.5,0},{-0.5,-1.4,0}};
...
void renderScene(void) {
	...
	glPushMatrix();
	getGlobalCatmullRomPoint(b,res2);
	glTranslatef(res[0],res[1],res[2]);
	glRotatef(100,5,5,5);
